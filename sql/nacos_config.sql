...
-- ----------------------------
INSERT INTO `his_config_info` VALUES (0, 1, 'study-zero-system', 'DEFAULT_GROUP', '', 'server:\r\n  port: 10002\r\n\r\nspring:\r\n  application:\r\n    name: study-zero-system\r\n  datasource:\r\n    url: jdbc:mysql://localhost:3306/zero?useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true&serverTimezone=Asia/Shanghai\r\n    username: root\r\n    password: root\r\n    type: com.alibaba.druid.pool.DruidDataSource\r\n    driver-class-name: com.mysql.cj.jdbc.Driver\r\n    filters: stat\r\n    maxActive: 100\r\n    initialSize: 1\r\n    maxWait: 60000\r\n    minIdle: 1\r\n    timeBetweenEvictionRunsMillis: 60000\r\n    minEvictableIdleTimeMillis: 300000\r\n    validationQuery: select \'x\'\r\n    testWhileIdle: true\r\n    testOnBorrow: false\r\n    testOnReturn: false\r\n    poolPreparedStatements: true\r\n    maxOpenPreparedStatements: 20\r\n  redis:\r\n    host: 127.0.0.1\r\n    port: 6379\r\n    password:\r\n    timeout: 300\r\n    jedis:\r\n      pool:\r\n        #连接池最大连接数（使用负值表示没有限制）\r\n        max-active: 8\r\n        #连接池中的最大空闲连接\r\n        max-idle: 500\r\n        #连接池最大阻塞等待时间（使用负值表示没有限制）\r\n        max-wait: -1\r\n        #连接池中的最小空闲连接\r\n        min-idle: 0\r\n    lettuce:\r\n      shutdown-timeout: 0\r\n\r\n\r\n# mybatis-plus相关配置\r\nmybatis-plus:\r\n  global-config:\r\n    db-config:\r\n      logic-delete-field: deleFlag # 全局逻辑删除的实体字段名(since 3.3.0,配置后可以忽略不配置步骤2)\r\n      logic-delete-value: 1 # 逻辑已删除值(默认为 1)\r\n      logic-not-delete-value: 0 # 逻辑未删除值(默认为 0)\r\n  # mybatis-plus相关配置\r\n  configuration:\r\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl\r\nconfig:\r\n  jwt:\r\n    # 加密密钥\r\n    secret: qwer\r\n    # token有效时长\r\n    expire: 300\r\n    #header 名称\r\n    header: accessToken\r\nlogging:\r\n  level:\r\n    com.demo: debug\r\n', '297fe0f939e1fad25bce0b87a7d067b5', '2023-11-14 17:39:38', '2023-11-14 09:39:39', NULL, '192.168.0.36', 'I', '', '');
